...
def generate_composition_in_thread(seed, generation_pattern):
    global temp_dir, metadata, progress, disabled_layers
    ...
    # Create empty layers for the composition, considering disabled layers
    ...
    # Process layers based on the user-defined pattern
    for tag in processing_order:
        for i, layer_folder in enumerate(layer_folders):
            # Check if the layer is disabled
